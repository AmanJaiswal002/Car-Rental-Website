  ...
  return (
    ...
    transition-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'>
        ...
        {(car.isAvailable ?? car.isAvaliable ?? true) && <p className='absolute top-4 left-4 bg-blue-600
        text-white text-xs px-3 py-1 rounded-full font-medium shadow-sm'>Available Now</p>}
