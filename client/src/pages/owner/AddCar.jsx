      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
         ...
         <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
           ...
           <div className='flex flex-col w-full'>
            ...
            <select required onChange={e=> setCar({...car, category: e.target.value})} value={car.category}
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
            ...
            <select required onChange={e=> setCar({...car, transmission: e.target.value})} value={car.transmission}
             className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <select required onChange={e=> setCar({...car, fuel_type: e.target.value})} value={car.fuel_type}
             className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
       ...
       {/* Car Description */}
        <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder="e.g A luxurious SUV with a spaciuos interior and a powerful engine." required
